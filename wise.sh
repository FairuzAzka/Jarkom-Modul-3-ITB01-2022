...
@               IN      A       10.45.2.2 ; IP WISE
www             IN      CNAME   wise.itb01.com.
' > /etc/bind/wise/wise.itb01.com
...
' > /etc/bind/wise/2.45.10.in-addr.arpa
...
zone "wise.itb01.com" {  
        type master;
        notify yes;
        also-notify {10.45.3.2;};  //Masukan IP Berlint tanpa tanda petik
        allow-transfer {10.45.3.2;}; // Masukan IP Berlint tanpa tanda petik
        file "/etc/bind/wise/wise.itb01.com";
};
